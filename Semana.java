...
public class Semana {
    public static void main(String[] args) {
        ...
        int menu=0, r=1, cont2=0, diametro=6;
        ...
        do {
            ...
            switch (menu) {
                case 1:
                    JOptionPane.showMessageDialog(null,"BIENVENIDO AL PROGRAMA NÚMEROS POSITIVOS Y NEGATIVOS","✪✪✪NÚMEROS✪✪✪",JOptionPane.QUESTION_MESSAGE);
                    resul1=numeros();
